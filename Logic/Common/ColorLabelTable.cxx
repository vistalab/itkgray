...
::ColorLabelTable()
{
  ...
  m_DefaultLabel[2].SetRGB(120,120,0);
  m_DefaultLabel[3].SetRGB(255,0,255);
  m_DefaultLabel[4].SetRGB(0,190,255);
  m_DefaultLabel[5].SetRGB(120,0,120);
  m_DefaultLabel[6].SetRGB(0,100,120);
  ...
  // Set some itkGray-specific label properties
  m_DefaultLabel[1].SetLabel("CSF");
  m_DefaultLabel[1].SetVisibleIn3D(false);
  m_DefaultLabel[2].SetLabel("sub-cortical GM");
  m_DefaultLabel[2].SetVisibleIn3D(false);
  m_DefaultLabel[3].SetLabel("left white");
  m_DefaultLabel[4].SetLabel("right white");
  m_DefaultLabel[5].SetLabel("left gray");
  m_DefaultLabel[6].SetLabel("right gray");
