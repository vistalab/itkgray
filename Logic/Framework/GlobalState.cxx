...
::GlobalState() 
{
  ...
  m_PaintbrushSettings.radius = 10.5;
  m_PaintbrushSettings.shape = PAINTBRUSH_FLOODFILL;
  m_PaintbrushSettings.flat = false;
  m_PaintbrushSettings.isotropic = true;
  m_PaintbrushSettings.chase = true;
  m_PaintbrushSettings.tolerance = 20;
  m_PaintbrushSettings.smoothing = 3;
}
