...
public:
  ...
  // IRIS: Topology callbacks
  virtual void OnGatherStatistics() = 0;
  virtual void OnFillCavities() = 0;
  virtual void OnDelSatelliteVol() = 0;
  virtual void OnFindHandles() = 0;
  virtual void OnGotoHandle() = 0;
  virtual void OnGotoNextHandleAction() = 0;
  virtual void OnGotoPrevHandleAction() = 0;
  virtual void OnSmoothLabel() = 0;
